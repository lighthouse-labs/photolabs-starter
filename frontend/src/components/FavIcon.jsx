...
const FavIcon = (props) => {
  ...
  const { handleShowFavsClick, displayAlert, fill } = props;
  
  return (
    <svg onClick={handleShowFavsClick} width="20" height="17" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
