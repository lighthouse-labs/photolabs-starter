...
const FavIcon = ({displayAlert, selected,setSidePeekForLikedPhotos}) => {
  return (
    <svg   className="photo-list__fav-icon-svg" 
    width= {selected ? "17" : "20"} height={selected ? "15" : "17"} viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
